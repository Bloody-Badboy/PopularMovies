...
@SuppressWarnings("WeakerAccess") final public class Injection {
  ...
  public static FavouriteMovieStore provideFavouriteMovieStore() {
    return FavouriteMovieStore.getInstance();
  }

  public static MoviesDataSource provideLocalDataSource() {
    return MoviesLocalDataSource.getInstance(Injection.provideFavouriteMovieStore());
  }
